"""
"STAY BLUE, STAY CURIOUS" 白テキスト版 SVG ジェネレーター
ダーク背景用。STAY/CURIOUS は白、BLUE はモザイク。
"""

import os

# --- フォント仕様 ---
TEXT_COLOR = "#FFFFFF"   # 白 (ダーク背景用)
...
if __name__ == '__main__':
    output_path = os.path.join(os.path.dirname(__file__), '..', 'images', 'stayblue-staycurious-white.svg')
